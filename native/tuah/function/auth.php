...
function daftar($post)
{
    ...
    $stmt = mysqli_prepare($konek, "INSERT INTO users (nama, email, sandi, image, role, createat) VALUES (?, ?, ?, ?, '2', ?)");
    
    // Bind parameters
    mysqli_stmt_bind_param($stmt, "sssss", $nama, $email, $sandi, $image, $createat);
